...
class TbForm extends \CForm {
	 ...
	 */
	public $inputElementClass = 'webnula2\widgets\booster\TbFormInputElement';
	 ...
	 */
	public $buttonElementClass = 'webnula2\widgets\booster\TbFormButtonElement';
	 ...
	 * @see TbActiveForm
	 */
	public $activeForm = array('class' => 'webnula2\widgets\booster\TbActiveForm');
	...
	public function renderBegin() {
		...
		if (!($this->getParent() instanceof self) and !isset($this->activeForm['class'])) {
			$this->activeForm['class'] = 'webnula2\widgets\booster\TbActiveForm';
		}
