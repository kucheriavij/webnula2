...
class NestedSetBehavior extends CActiveRecordBehavior
{
	...
	{
		return $this->children()->find($criteria);
	}
	 ...
	 * @return CActiveRecord[]
	 */
	public function getChildrens($criteria=array(), $depth=null)
	{
		return $this->descendants($depth)->findAll($criteria);
	}
	...
	{
		return $this->parent()->find($condition='', $params);
	}
	 ...
	 * @return CActiveRecord[]
	 */
	public function getParents($condition='', $params=array(),$depth=null)
	{
		return $this->ancestors($depth)->findAll($condition='', $params);
	}
	 ...
	 * @return CActiveRecord
	 */
	public function getPrev($condition='', $params=array())
	{
		return $this->prev()->find($condition='', $params);
	}
	 ...
	 * @return CActiveRecord
	 */
	public function getNext($condition='', $params=array())
	{
		return $this->next()->find($condition='', $params);
	}
