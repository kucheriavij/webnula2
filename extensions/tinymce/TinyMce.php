...
class TinyMce extends CInputWidget
{
	...
	private static $defaultSettings = array(
		...
		'toolbar' => "insertfile undo redo | formatselect styleselect removeformat | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | code link image | print preview media | forecolor backcolor",
	...
	private function registerScripts($id)
	{
		...
		$cs->registerScriptFile($this->assetsDir . '/js/tinymce.min.js');
		...
		$this->settings['selector'] = '#'.CHtml::activeId($this->model, $this->attribute);
