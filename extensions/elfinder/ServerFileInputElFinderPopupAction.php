...
class ServerFileInputElFinderPopupAction extends CAction {
	...
	public function run() {
		Yii::import('webnula2.extensions.elfinder.ElFinderHelper');
		...
		$this->controller->render('webnula2.extensions.elfinder.views.ServerFileInputElFinderPopupAction', array('title' => $this->title,
