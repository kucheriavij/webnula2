...
class ESmartyViewRenderer extends CApplicationComponent implements IViewRenderer
{
	 ...
	 */
	public $smartyDir = 'webroot.vendor.smarty.smarty.distribution.libs';
	...
	public function init(){
		...
		$compileDir = isset($this->config['compile_dir']) ?
			Yii::getPathOfAlias( $this->config['compile_dir'] ) : Yii::app()->getRuntimePath().'/smarty/compiled/';
	...
	public function renderFile($context,$sourceFile,$data,$return)
	{
		...
		$data = array_merge($this->tpl_vars, $data);
